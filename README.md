...
-	ESP32 
-	LCD (16x2 with I2C)
-	PIR sensor (PIR is a digital sensor that gives an output of either high or low = motion or no motion)
  
### Circuit Diagram 
The figure below shows the connection of the components to make the circuit that will print "Motion Detected" whenever the PIR sensor detects motion, and print "No Motion" when the PIR sensor detects nothing. 
